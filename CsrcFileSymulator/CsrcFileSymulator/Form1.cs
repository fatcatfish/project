...
namespace CsrcFileSymulator
{
    public partial class IpdpBatchFileReader : Form
    {
        ...
        private void fileAnalysis(String selectMode,String inputStr)
        {
            ...
            String[] paramNameListOcrm = { "IPDP_CODE", "BODY_LENGTH", "DETAIL_FLAG", "TRANSACTION_ACCOUNT_ID", "ORDER_SEQ ", "CUSTOMER_ID", "PROVINCE_BRANCHNO", "ACCOUNT_NO", "ACCOUNT_TYPE", "PRODUCT_ID", "PRODUCT_TYPE", "SUB_POSITION_SEQ", "POSITION_TYPE", "TOTAL_VOL", "FROZON_VOL", "BUSINESS_CODE", "CURRENCY_SIGN", "TRANSACTION_AMOUNT", "TRANSACTION_VOL", "CONFIRMED_AMOUNT", "CONFIRMED_VOL", "UNCONFIRMED_AMOUNT", "UNCONFIRMED_VOL", "UPDATE_TIME", "ORDER_STATUS", "BUFFER" };
            String[] paramCNameListOcrm = { "交易码", "报文长度", "明细/持仓标识", "投资人交易账号", "订单编号", "核心客户号", "所属省行号", "资金账号/卡号", "卡号/账号类型", "产品代码", "产品大类", "分仓号", "分仓类型", "交易后持仓总份额", "交易后当日冻结份额", "交易码", "币种", "申请金额", "申请份额", "成交资金额", "成交基金份额", "未成交资金额", "未成交基金份额", "数据更新时间", "订单状态", "备用域" };
            int[] paramStartPosOcrm = { 1, 8, 13, 14, 34, 50, 67, 72, 104, 105, 137, 139, 148, 151, 169, 187, 190, 193, 211, 229, 247, 265, 283, 301, 315, 319, 2319 };
            String[] paramTypeOcrm = { "CHAR", "NUMBER", "CHAR", "CHAR", "CHAR", "CHAR", "CHAR", "CHAR", "CHAR", "CHAR", "CHAR", "NUMBER", "CHAR", "NUMBER", "NUMBER", "CHAR", "CHAR", "NUMBER", "NUMBER", "NUMBER", "NUMBER", "NUMBER", "NUMBER", "CHAR", "CHAR", "CHAR" };

            String[] paramNameListCtis = { "START_FLAG", "FILLER", "CUSTOMER_ID", "FILLER", "TRANSACTION_ACCOUNT_ID", "FILLER", "ACCOUNT_NO", "FILLER", "ACCOUNT_NO", "FILLER", "BUSINESS_CODE", "FILLER", "SHOW_TYPE_CODE", "FILLER", "SHOW_SUBTYPE_CODE", "FILLER", "CURRENCY_SIGN", "FILLER", "WORKING_DATE", "FILLER", "ORDER_SEQ", "FILLER", "TRANSACTION_ACCOUNT_STATUS", "FILLER", "SEND_DATE", "FILLER", "PRODUCT_TYPE", "FILLER", "POSITION_TYPE", "FILLER", "SUB_POSITION_SEQ", "FILLER", "NAV", "FILLER", "NAV_UPDATE_DATE", "FILLER", "ORDER_STATUS", "FILLER", "ACCOUNTING_STATUS", "FILLER", "QREDEEM_APPLICATION_VOL", "FILLER", "TOTAL_VOL", "FILLER", "END_FLAG" };
            String[] paramCNameListCtis = { "固定字段（开始标识）", "分隔符", "核心客户号", "分隔符", "投资人交易账号", "分隔符", "资金账号/卡号", "分隔符", "产品代码", "分隔符", "交易码", "分隔符", "产品展示分类", "分隔符", "产品展示子类", "分隔符", "币种", "分隔符", "金融类订单所属工作日", "分隔符", "金融类订单编号", "分隔符", "投资人交易账号状态", "分隔符", "数据推送日期", "分隔符", "产品大类", "分隔符", "分仓类型", "分隔符", "分仓编号", "分隔符", "产品最新净值", "分隔符", "净值截止日期", "分隔符", "订单状态", "分隔符", "资金状态", "分隔符", "快赎订单申请份额", "分隔符", "客户总持仓额", "分隔符", "固定字段（结束标识）" };
            int[] paramStartPosCtis = { 1, 5, 8, 25, 28, 48, 51, 83, 86, 118, 121, 124, 127, 130, 133, 136, 139, 142, 145, 153, 156, 172, 175, 177, 180, 188, 191, 193, 196, 199, 202, 211, 214, 221, 224, 232, 235, 239, 242, 246, 249, 265, 268, 284, 287, 290 };
            String[] paramTypeCtis = { "CHAR", "CHAR", "CHAR", "CHAR", "CHAR", "CHAR", "CHAR", "CHAR", "CHAR", "CHAR", "CHAR", "CHAR", "CHAR", "CHAR", "CHAR", "CHAR", "CHAR", "CHAR", "CHAR", "CHAR", "NUMBER", "CHAR", "CHAR", "CHAR", "CHAR", "CHAR", "CHAR", "CHAR", "CHAR", "CHAR", "CHAR", "CHAR", "CHAR", "CHAR", "CHAR", "CHAR", "CHAR", "CHAR", "CHAR", "CHAR", "CHAR", "CHAR", "CHAR", "CHAR", "CHAR" };
            ...
            switch (selectMode) {
                ...
                case "BTA非标F4文件":
                    ...
                    break;
                case "其他OCRM直传文件":
                    paramGenerator(flowLayout, inputStr, paramNameListOcrm, paramCNameListOcrm, paramTypeOcrm, paramStartPosOcrm);
                    break;
                case "其他CTIS-BUFFER域文件":
                    paramGenerator(flowLayout, inputStr, paramNameListCtis, paramCNameListCtis, paramTypeCtis, paramStartPosCtis);
                    break;
            }
        ...
        private void btCopyClick(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("无法创建文件" + @"D:\testCsrcFile.txt中");
            }
        ...
        public void paramGenerator(FlowLayoutPanel flowLayout,String inputStr,String[] paramNameList,String[] paramCNameList,String[] paramType,int[] paramStartPos) {
            for (int i = 0; i < paramNameList.Length; i++)
            {
                ...
                if (paramNameList[i].Equals("FUNDCODE") || paramNameList[i].Equals("TransactionAccountID") || paramNameList[i].Equals("FundCode") || paramNameList[i].Equals("TRANSACTIONACCOUNTID")) {
                    textBox.BackColor = Color.Yellow;
                    textBox.Font = new Font("宋体", 10.5f, FontStyle.Underline);
                }
                if (paramNameList[i].Equals("BUSINESSCODE") || paramNameList[i].Equals("BusinessCode") || paramNameList[i].Equals("RETURNCODE") || paramNameList[i].Equals("ReturnCode"))
                {
        ...
        private void oCRM直传ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            textBox1.Text = oCRM直传ToolStripMenuItem.OwnerItem.Text + oCRM直传ToolStripMenuItem.Text + "文件";
        }

        private void cTISBUFFER域ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            textBox1.Text = cTISBUFFER域ToolStripMenuItem.OwnerItem.Text + cTISBUFFER域ToolStripMenuItem.Text + "文件";
        }

        private void 常用sqlToolStripMenuItem_Click(object sender, EventArgs e)
        {
            SqlForm testForm = new SqlForm();
            testForm.Text = "常用SQL";
            testForm.Show(); 
        }
    }
